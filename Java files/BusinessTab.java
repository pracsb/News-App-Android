 ...
 */
public class BusinessTab extends Fragment implements CardAdapter.OnItemClickListener, CardAdapter.OnLongClickListener,CardAdapter.OnBkClickListener{
    ...
    private View return_fragment_business;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return_fragment_business = inflater.inflate(R.layout.fragment_business_tab, container, false);
        mRecyclerView = return_fragment_business.findViewById(R.id.recycler_view);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(requireActivity().getApplicationContext()));
        progressBar = return_fragment_business.findViewById(R.id.progressBar1);
        progressText = return_fragment_business.findViewById(R.id.progress_text);

        swipeRefreshLayout = return_fragment_business.findViewById(R.id.swipe);
        ...
        mRequestQueue = Volley.newRequestQueue(requireActivity().getApplicationContext());
        parseJSON();
        return return_fragment_business;
    }

    private void parseJSON(){
        String url = "https://hw8webtech.wl.r.appspot.com/guardian_business";
...
//                                month = temp_month.substring(0,1).toUpperCase() + temp_month.substring(1);
                            ...
                            mCardAdapter.setOnItemClickListener(BusinessTab.this);
                            mCardAdapter.setOnLongClickListener(BusinessTab.this);
                            mCardAdapter.setOnBkClickListener(BusinessTab.this);}
