 ...
 * Use the {@link WorldTab#newInstance} factory method to
 * create an instance of this fragment.
 */
public class WorldTab extends Fragment implements CardAdapter.OnItemClickListener, CardAdapter.OnLongClickListener, CardAdapter.OnBkClickListener{
    ...
    private View return_fragment_world;
     ...
     * @return A new instance of fragment WorldTab.
     */
    // TODO: Rename and change types and number of parameters
    public static WorldTab newInstance(String param1, String param2) {
        WorldTab fragment = new WorldTab();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return_fragment_world = inflater.inflate(R.layout.fragment_world_tab, container, false);
        mRecyclerView = return_fragment_world.findViewById(R.id.recycler_view);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(requireActivity().getApplicationContext()));
        progressBar = return_fragment_world.findViewById(R.id.progressBar1);
        progressText = return_fragment_world.findViewById(R.id.progress_text);
        swipeRefreshLayout = return_fragment_world.findViewById(R.id.swipe);
...
//        Toast.makeText(getContext(), "\""+curr_title +"\""+" was added to bookmarks", Toast.LENGTH_SHORT).show();
    ...
    private void parseJSON(){
        String url = "https://hw8webtech.wl.r.appspot.com/guardian_world";
...
//                                month = temp_month.substring(0,1).toUpperCase() + temp_month.substring(1);
                            ...
                            mCardAdapter.setOnItemClickListener(WorldTab.this);
                            mCardAdapter.setOnLongClickListener(WorldTab.this);
                            mCardAdapter.setOnBkClickListener(WorldTab.this);}
