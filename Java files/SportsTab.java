 ...
 */
public class SportsTab extends Fragment implements CardAdapter.OnItemClickListener, CardAdapter.OnLongClickListener, CardAdapter.OnBkClickListener{
    ...
    private View return_fragment_sports;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return_fragment_sports = inflater.inflate(R.layout.fragment_sports_tab, container, false);

        mRecyclerView = return_fragment_sports.findViewById(R.id.recycler_view);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(requireActivity().getApplicationContext()));
        progressBar = return_fragment_sports.findViewById(R.id.progressBar1);
        progressText = return_fragment_sports.findViewById(R.id.progress_text);
        swipeRefreshLayout = return_fragment_sports.findViewById(R.id.swipe);
        ...
        return return_fragment_sports;
    }

    private void parseJSON(){
        String url = "https://hw8webtech.wl.r.appspot.com/guardian_sports";
...
//                                month = temp_month.substring(0,1).toUpperCase() + temp_month.substring(1);
                            ...
                            mCardAdapter.setOnItemClickListener(SportsTab.this);
                            mCardAdapter.setOnLongClickListener(SportsTab.this);
                            mCardAdapter.setOnBkClickListener(SportsTab.this);}
