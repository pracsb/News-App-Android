 ...
 */
public class ScienceTab extends Fragment implements CardAdapter.OnItemClickListener, CardAdapter.OnLongClickListener, CardAdapter.OnBkClickListener{
    ...
    private View return_fragment_science;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return_fragment_science = inflater.inflate(R.layout.fragment_science_tab, container, false);

        mRecyclerView = return_fragment_science.findViewById(R.id.recycler_view);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(requireActivity().getApplicationContext()));
        progressBar = return_fragment_science.findViewById(R.id.progressBar1);
        progressText = return_fragment_science.findViewById(R.id.progress_text);
        swipeRefreshLayout = return_fragment_science.findViewById(R.id.swipe);
        ...
        return return_fragment_science;
    }

    private void parseJSON(){
        String url = "https://hw8webtech.wl.r.appspot.com/guardian_science";
...
//                                month = temp_month.substring(0,1).toUpperCase() + temp_month.substring(1);
                            ...
                            mCardAdapter.setOnItemClickListener(ScienceTab.this);
                            mCardAdapter.setOnLongClickListener(ScienceTab.this);
                            mCardAdapter.setOnBkClickListener(ScienceTab.this);}
