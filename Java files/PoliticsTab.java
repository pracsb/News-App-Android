 ...
 * Use the {@link PoliticsTab#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PoliticsTab extends Fragment implements CardAdapter.OnItemClickListener, CardAdapter.OnLongClickListener, CardAdapter.OnBkClickListener {
    ...
    private View return_fragment_politics;
     ...
     * @return A new instance of fragment PoliticsTab.
     */
    // TODO: Rename and change types and number of parameters
    public static PoliticsTab newInstance(String param1, String param2) {
        PoliticsTab fragment = new PoliticsTab();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return_fragment_politics = inflater.inflate(R.layout.fragment_politics_tab, container, false);

        mRecyclerView = return_fragment_politics.findViewById(R.id.recycler_view);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(requireActivity().getApplicationContext()));
        progressBar = return_fragment_politics.findViewById(R.id.progressBar1);
        progressText = return_fragment_politics.findViewById(R.id.progress_text);
        swipeRefreshLayout = return_fragment_politics.findViewById(R.id.swipe);
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() { mCardList = new ArrayList<>();
        ...
        return return_fragment_politics;
    }


    private void parseJSON(){
        String url = "https://hw8webtech.wl.r.appspot.com/guardian_politics";
...
//                                month = temp_month.substring(0,1).toUpperCase() + temp_month.substring(1);
                            ...
                            mCardAdapter.setOnItemClickListener(PoliticsTab.this);
                            mCardAdapter.setOnLongClickListener(PoliticsTab.this);
                            mCardAdapter.setOnBkClickListener(PoliticsTab.this);}
